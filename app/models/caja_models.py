...
def _validar_texto_sin_numeros(value: str, nombre_campo: str, obligatorio: bool = True) -> str:
    ...
    if any(char.isdigit() for char in texto):
        raise ValueError(f"El campo {nombre_campo} no puede contener números")
    return texto
...
class ConceptoValorItem(BaseModel):
    ...
    def validar_concepto(cls, v):
        return _validar_texto_sin_numeros(v, "concepto")
...
class BonoEntrada(BaseModel):
    ...
    def validar_cliente(cls, v):
        return _validar_texto_sin_numeros(v, "nombre del cliente")
...
class PrestamoEntrada(BaseModel):
    ...
    def validar_persona(cls, v):
        return _validar_texto_sin_numeros(v, "nombre de la persona")
...
class MovimientoEntrada(BaseModel):
    ...
    def validar_observacion(cls, v):
        return _validar_texto_sin_numeros(v, "observación", obligatorio=False)
